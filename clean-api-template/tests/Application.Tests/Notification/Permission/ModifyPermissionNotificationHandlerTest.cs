...
public class ModifyPermissionNotificationHandlerTest
{
    ...
    private readonly ModifyPermissionNotificationHandler _handler;

    public ModifyPermissionNotificationHandlerTest()
    {
        ...
        _handler = new ModifyPermissionNotificationHandler(_kafkaServiceMock.Object, _elasticSearchServiceMock.Object);
    }
    ...
    public async Task Handle_ShouldCallKafkaProduceAsync_AndElasticSearchIndex()
    {
        ...
        var notification = new ModifyPermissionNotification(permission);
        ...
        _elasticSearchServiceMock.Verify(e => e.IndexAsync(permission, "modify-permissions"), Times.Once);
    }
    ...
    public async Task Handle_WhenKafkaFails_ShouldNotCallElasticSearch()
    {
        ...
        _elasticSearchServiceMock.Verify(e => e.IndexAsync(permission, "modify-permissions"), Times.Never);
    }
