...
public class GetPermissionNotificationHandlerTest
{
    ...
    private readonly GetPermissionNotificationHandler _handler;

    public GetPermissionNotificationHandlerTest()
    {
        ...
        _handler = new GetPermissionNotificationHandler(_kafkaServiceMock.Object, _elasticSearchServiceMock.Object);
    }
    ...
    public async Task Handle_ShouldCallKafkaProduceAsync_AndElasticSearchIndex()
    {
        ...
        var notification = new GetPermissionNotification(permission);
        ...
        _elasticSearchServiceMock.Verify(e => e.IndexAsync(permission, "permissions-id"), Times.Once);
    }
